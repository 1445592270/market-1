...
SERVER_NAME = config("SERVER_NAME", default="market")
SERVER_HOST = config("SERVER_HOST ", default="market")
PROJECT_NAME = config("PROJECT_NAME", default="market")

DEBUG = config("MARKET_APP_DEBUG", cast=bool, default=False)
GEN_DOCS = config("GEN_DOCS", cast=bool, default=False)

# the market id
MARKET_ID = config("MARKET_ID", cast=int, default=1)
#MARKET_ID = 1
ENABLE_ENDUSER = config("ENABLE_ENDUSER", cast=bool, default=True)
ENABLE_ADMIN = config("ENABLE_ADMIN", cast=bool, default=False)
API_PREFIX = config("API_PREFIX", default="/xxx")
ADMIN_API_PREFIX = config("ADMIN_API_PREFIX", default="/xxx/fake")
...
FIRST_SUPERUSER_PASSWORD = config("FIRST_SUPERUSER_PASSWORD", default="Market.12345")
...
SMS_CLI_ACCESSSECRET = config("SMS_CLI_ACCESSSECRET", default="NOOP")
...
QP_WEB_DB_HOST = config("QP_WEB_DB_HOST", default="localhost")
QP_WEB_DB_PORT = config("QP_WEB_DB_PORT", cast=int, default=3306)
QP_WEB_DB_USER = config("QP_WEB_DB_USER", default="")
QP_WEB_DB_PASSWORD = config("QP_WEB_DB_PASSWORD", default="")
QP_WEB_DB_NAME = config("QP_WEB_DB_NAME", default="wk_aq")
QP_WEB_DB_UNIX_SOCKET = config("QP_WEB_DB_UNIX_SOCKET", default=None)
QP_WEB_DB_CHARSET = config("QP_WEB_DB_CHARSET", default="")
