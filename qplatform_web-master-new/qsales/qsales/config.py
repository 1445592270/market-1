...
SERVER_NAME = config("SERVER_NAME", default="qsales")
SERVER_HOST = config("SERVER_HOST ", default="qsales")
PROJECT_NAME = config("PROJECT_NAME", default="qsales")
